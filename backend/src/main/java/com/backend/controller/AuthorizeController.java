...
public class AuthorizeController {
    ...
    public RestBean<String> registerUser(@RequestParam("username") String username,
        ...
        adminAccount.setAdminUsername(username);
        adminAccount.setPassword(password);
        adminAccount.setEmail(email);

        String s = service.registerAccount(adminAccount, code);
        if (s == null) {
                                            ...
                                            )
    {
        ...
        admin.setAdminUsername(pUsername);
        admin.setAddress(pAddress);
        admin.setAge(Integer.parseInt(pAge));
        admin.setBirthday(pBirthday);
        admin.setName(pName);
        admin.setSex(pSex);
        admin.setIdCard(pIdCard);
        admin.setPhone(pPhone);
        admin.setSignature(mdescription);
        if (service.updateAccount(admin)) {
