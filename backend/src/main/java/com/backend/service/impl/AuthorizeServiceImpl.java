...
//    StringRedisTemplate redisTemplate;
    ...
    //管理员注册
    @Override
    public String registerAccount(Account account, String code) {
        if ((mapper.findByUsernameOrEmail(account.getUsername()) != null))
            return "用户名已存在";
        if (code == null)
            return "请先发送获取验证码";
    ...
    @Override
    public AccountInfo findAllAccount(String username) {
...
//            }
//        }
        Account account = mapper.findByUsernameOrEmail(email);
